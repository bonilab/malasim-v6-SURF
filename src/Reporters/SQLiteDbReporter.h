...
private:
  // SQL query templates
  const std::string insert_genotype_query_ = "INSERT INTO genotype (id, name) VALUES (?, ?);";

  const std::string insert_admin_level_query_ = "INSERT INTO admin_level (id, name) VALUES (?, ?);";
...
protected:
  void initialize_database(int job_number,

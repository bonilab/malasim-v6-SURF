...
TEST_F(GenotypeParametersTest, DecodeGenotypeParameters) {
  ...
  node["pf_genotype_info"][0]["genes"][0]["multiplicative_effect_on_EC50_for_2_or_more_mutations"]
      [0]["drug_id"] = 1;
  node["pf_genotype_info"][0]["genes"][0]["multiplicative_effect_on_EC50_for_2_or_more_mutations"]
      [0]["factor"] = 1.05;
  ...
  node["pf_genotype_info"][0]["genes"][0]["cnv_multiplicative_effect_on_EC50"][0]["factors"] =
      std::vector<double>{1.0, 2.44444444};
  node["pf_genotype_info"][0]["genes"][0]["cnv_multiplicative_effect_on_EC50"][1]["drug_id"] = 1;
  node["pf_genotype_info"][0]["genes"][0]["cnv_multiplicative_effect_on_EC50"][1]["factors"] =
      std::vector<double>{1.0, 1.3};
  node["pf_genotype_info"][0]["genes"][0]["aa_positions"][0]["position"] = 86;
  node["pf_genotype_info"][0]["genes"][0]["aa_positions"][0]["amino_acids"] =
      std::vector<std::string>{"N", "Y"};
  node["pf_genotype_info"][0]["genes"][0]["aa_positions"][0]["daily_crs"] =
      std::vector<double>{0.0, 0.0005};
  node["pf_genotype_info"][0]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][0]
      ["drug_id"] = 6;
  node["pf_genotype_info"][0]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][0]
      ["factors"] = std::vector<double>{1.0, 1.25};
  node["pf_genotype_info"][0]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][1]
      ["drug_id"] = 1;
  node["pf_genotype_info"][0]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][1]
      ["factors"] = std::vector<double>{1.25, 1.0};

  node["pf_genotype_info"][1]["chromosome"] = 7;
  node["pf_genotype_info"][1]["genes"][0]["name"] = "Pfcrt";
  node["pf_genotype_info"][1]["genes"][0]["multiplicative_effect_on_EC50_for_2_or_more_mutations"]
      [0]["drug_id"] = 3;
  node["pf_genotype_info"][1]["genes"][0]["multiplicative_effect_on_EC50_for_2_or_more_mutations"]
      [0]["factor"] = 1.0;
  node["pf_genotype_info"][1]["genes"][0]["average_daily_crs"] = 0.1290;
  node["pf_genotype_info"][1]["genes"][0]["aa_positions"][0]["position"] = 76;
  node["pf_genotype_info"][1]["genes"][0]["aa_positions"][0]["amino_acids"] =
      std::vector<std::string>{"K", "T"};
  node["pf_genotype_info"][1]["genes"][0]["aa_positions"][0]["daily_crs"] =
      std::vector<double>{0.0, 0.003875969};
  node["pf_genotype_info"][1]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][0]
      ["drug_id"] = 6;
  node["pf_genotype_info"][1]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][0]
      ["factors"] = std::vector<double>{1.0, 1.6};
  node["pf_genotype_info"][1]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][1]
      ["drug_id"] = 1;
  node["pf_genotype_info"][1]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][1]
      ["factors"] = std::vector<double>{1.1, 1.0};
  node["pf_genotype_info"][1]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][2]
      ["drug_id"] = 2;
  node["pf_genotype_info"][1]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][2]
      ["factors"] = std::vector<double>{1.0, 1.2};

  // Chromosome 13 data (Pfkelch13 gene)
  node["pf_genotype_info"][2]["chromosome"] = 13;
  node["pf_genotype_info"][2]["genes"][0]["name"] = "Pfk13";
  node["pf_genotype_info"][2]["genes"][0]["multiplicative_effect_on_EC50_for_2_or_more_mutations"]
      [0]["drug_id"] = 0;
  node["pf_genotype_info"][2]["genes"][0]["multiplicative_effect_on_EC50_for_2_or_more_mutations"]
      [0]["factor"] = 1.1;
  node["pf_genotype_info"][2]["genes"][0]["aa_positions"][0]["position"] = 446;
  node["pf_genotype_info"][2]["genes"][0]["aa_positions"][0]["amino_acids"] =
      std::vector<std::string>{"F", "I"};
  node["pf_genotype_info"][2]["genes"][0]["aa_positions"][0]["daily_crs"] =
      std::vector<double>{0.0, 0.0005};
  node["pf_genotype_info"][2]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][0]
      ["drug_id"] = 0;
  node["pf_genotype_info"][2]["genes"][0]["aa_positions"][0]["multiplicative_effect_on_EC50"][0]
      ["factors"] = std::vector<double>{1.0, 1.6648};
  ...
  node["pf_genotype_info"][3]["genes"][0]["cnv_multiplicative_effect_on_EC50"][0]["factors"] =
  ...
  // Validate decoding
  EXPECT_EQ(decoded_parameters.get_mutation_mask(), kMutationMask);
  ...
  EXPECT_EQ(decoded_parameters.get_override_ec50_patterns()[0].get_pattern(),
            "||||NY1||1111111,0||||||000000000010|1");
  EXPECT_EQ(decoded_parameters.get_initial_parasite_info_raw()[0].get_location_id(), -1);

  // Validate Chromosome 5
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info().chromosome_infos[4].get_chromosome_id(), 5);
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info().chromosome_infos[4].get_genes()[0].get_name(),
            "Pfmdr1");
  EXPECT_EQ(
      decoded_parameters.get_pf_genotype_info().chromosome_infos[4].get_genes()[0].get_max_copies(),
      2);
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[4]
                .get_genes()[0]
                .get_cnv_reversion_multiplier(),
            0.5);
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[4]
                .get_genes()[0]
  ...
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[4]
                .get_genes()[0]
                .get_cnv_multiplicative_effect_on_EC50()[0]
                .get_drug_id(),
            4);
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[4]
  ...
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[4]
                .get_genes()[0]
                .get_cnv_multiplicative_effect_on_EC50()[1]
                .get_drug_id(),
            1);
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[4]
  ...
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                ...
                .get_genes()[0]
                .get_aa_positions()[0]
                .get_multiplicative_effect_on_EC50()[0]
                .get_drug_id(),
            6);
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[4]
  ...
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                ...
                .get_genes()[0]
                .get_aa_positions()[0]
                .get_multiplicative_effect_on_EC50()[1]
                .get_drug_id(),
            1);
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[4]
  ...
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info().chromosome_infos[6].get_genes()[0].get_name(),
            "Pfcrt");
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[6]
                .get_genes()[0]
                .get_average_daily_crs(),
            0.1290);
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[6]
                .get_genes()[0]
  ...
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                ...
                .get_genes()[0]
                .get_aa_positions()[0]
                .get_multiplicative_effect_on_EC50()[2]
                .get_drug_id(),
            2);
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[6]
  ...
  EXPECT_EQ(
      decoded_parameters.get_pf_genotype_info().chromosome_infos[12].get_genes()[0].get_name(),
      "Pfk13");
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[12]
                .get_genes()[0]
  ...
  EXPECT_EQ(
      decoded_parameters.get_pf_genotype_info().chromosome_infos[13].get_genes()[0].get_name(),
      "Pfpm23");
  EXPECT_EQ(decoded_parameters.get_pf_genotype_info()
                .chromosome_infos[13]
                .get_genes()[0]
